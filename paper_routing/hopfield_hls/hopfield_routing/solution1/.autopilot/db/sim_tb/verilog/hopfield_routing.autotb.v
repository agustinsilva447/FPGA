...
`define AUTOTB_TVIN_V  "./c.hopfield_routing.autotvin_V.dat"
`define AUTOTB_TVIN_U_0  "./c.hopfield_routing.autotvin_U_0.dat"
`define AUTOTB_TVIN_U_1  "./c.hopfield_routing.autotvin_U_1.dat"
`define AUTOTB_TVIN_U_2  "./c.hopfield_routing.autotvin_U_2.dat"
`define AUTOTB_TVIN_I  "./c.hopfield_routing.autotvin_I.dat"
`define AUTOTB_TVIN_T  "./c.hopfield_routing.autotvin_T.dat"
`define AUTOTB_TVIN_A  "./c.hopfield_routing.autotvin_A.dat"
`define AUTOTB_TVIN_B  "./c.hopfield_routing.autotvin_B.dat"
`define AUTOTB_TVIN_C  "./c.hopfield_routing.autotvin_C.dat"
`define AUTOTB_TVIN_l  "./c.hopfield_routing.autotvin_l.dat"
`define AUTOTB_TVIN_V_out_wrapc  "./rtl.hopfield_routing.autotvin_V.dat"
`define AUTOTB_TVIN_U_0_out_wrapc  "./rtl.hopfield_routing.autotvin_U_0.dat"
`define AUTOTB_TVIN_U_1_out_wrapc  "./rtl.hopfield_routing.autotvin_U_1.dat"
`define AUTOTB_TVIN_U_2_out_wrapc  "./rtl.hopfield_routing.autotvin_U_2.dat"
`define AUTOTB_TVIN_I_out_wrapc  "./rtl.hopfield_routing.autotvin_I.dat"
`define AUTOTB_TVIN_T_out_wrapc  "./rtl.hopfield_routing.autotvin_T.dat"
`define AUTOTB_TVIN_A_out_wrapc  "./rtl.hopfield_routing.autotvin_A.dat"
`define AUTOTB_TVIN_B_out_wrapc  "./rtl.hopfield_routing.autotvin_B.dat"
`define AUTOTB_TVIN_C_out_wrapc  "./rtl.hopfield_routing.autotvin_C.dat"
`define AUTOTB_TVIN_l_out_wrapc  "./rtl.hopfield_routing.autotvin_l.dat"
`define AUTOTB_TVOUT_V  "./c.hopfield_routing.autotvout_V.dat"
`define AUTOTB_TVOUT_U_0  "./c.hopfield_routing.autotvout_U_0.dat"
`define AUTOTB_TVOUT_V_out_wrapc  "./impl_rtl.hopfield_routing.autotvout_V.dat"
`define AUTOTB_TVOUT_U_0_out_wrapc  "./impl_rtl.hopfield_routing.autotvout_U_0.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.hopfield_routing.autotvout_V.dat", "r");
    fp2 = $fopen("./impl_rtl.hopfield_routing.autotvout_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.hopfield_routing.autotvout_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.hopfield_routing.autotvout_V.dat\"!");
    else begin
        $display("Comparing rtl.hopfield_routing.autotvout_V.dat with impl_rtl.hopfield_routing.autotvout_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.hopfield_routing.autotvout_U_0.dat", "r");
    fp2 = $fopen("./impl_rtl.hopfield_routing.autotvout_U_0.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.hopfield_routing.autotvout_U_0.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.hopfield_routing.autotvout_U_0.dat\"!");
    else begin
        $display("Comparing rtl.hopfield_routing.autotvout_U_0.dat with impl_rtl.hopfield_routing.autotvout_U_0.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
