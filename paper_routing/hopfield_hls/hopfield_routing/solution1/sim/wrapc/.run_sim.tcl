...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "hopfield_routing.autotvin.dat"
	set constFileTvOut       "hopfield_routing.autotvout.dat"
	set constFileHdlTvIn     "hopfield_routing.autohdltvin.dat"
	set constFileHdlTvOut    "hopfield_routing.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
