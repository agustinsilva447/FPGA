...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.hopfield_routing.autotvin_V.dat"
         "c.hopfield_routing.autotvin_U_0.dat"
         "c.hopfield_routing.autotvin_U_1.dat"
         "c.hopfield_routing.autotvin_U_2.dat"
         "c.hopfield_routing.autotvin_I.dat"
         "c.hopfield_routing.autotvin_T.dat"
         "c.hopfield_routing.autotvin_A.dat"
         "c.hopfield_routing.autotvin_B.dat"
         "c.hopfield_routing.autotvin_C.dat"
         "c.hopfield_routing.autotvin_l.dat"
         "c.hopfield_routing.autotvout_V.dat"
         "c.hopfield_routing.autotvout_U_0.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.hopfield_routing.autotvout_V.dat"
         "rtl.hopfield_routing.autotvout_U_0.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
