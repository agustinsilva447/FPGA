...
if {[file isfile hopfield_routing.autotvin.dat]} {
	file delete -force hopfield_routing.autotvin.dat
}

if {[file isfile hopfield_routing.autotvout.dat]} {
	file delete -force hopfield_routing.autotvout.dat
}
