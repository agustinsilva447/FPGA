...
// ==============================================================
#ifndef __hopfield_routing_eOg__HH__
#define __hopfield_routing_eOg__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(hopfield_routing_eOg) {
    ...
    SC_CTOR(hopfield_routing_eOg):  ACMP_sitofp_U ("ACMP_sitofp_U") {
