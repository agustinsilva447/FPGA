...
"""                    
laten = np.array([                                                   118,   134,   152,   172,   194,  
                    218,   244,   272,   302,   334,   368,   404,   442,   482,   524,   568,   614,
                    662,   712,   764,   818,   874,   992,   1054,  1118,  1184])
                    
lut   = np.array([                                                   11869, 12713, 13607, 14623, 15761, 
                    16941, 18219, 19675, 21229, 22961, 24631, 26399, 28265, 30229, 32235, 34147, 35705,
                    37289, 38938, 40655, 42437, 44285, 48179, 50225, 52337, 54515])      
...
axs[0].plot(nodes_h, lut, "b-o")
axs[0].set_title("HNN FPGA LUTs")
axs[0].set_xlabel("Nodes (number)")
axs[0].set_ylabel("LUTs (number)")
axs[1].plot(nodes_h, laten, "r-o")
axs[1].set_title("HNN FPGA Latency")
