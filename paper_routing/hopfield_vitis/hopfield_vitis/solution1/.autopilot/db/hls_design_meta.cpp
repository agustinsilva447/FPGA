...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("V_Addr_A", 32, hls_out, 0, "bram", "MemPortADDR2", 1),
	Port_Property("V_EN_A", 1, hls_out, 0, "bram", "MemPortCE2", 1),
	Port_Property("V_WEN_A", 4, hls_out, 0, "bram", "MemPortWE2", 1),
	Port_Property("V_Din_A", 32, hls_out, 0, "bram", "MemPortDIN2", 1),
	Port_Property("V_Dout_A", 32, hls_in, 0, "bram", "MemPortDOUT2", 1),
	Port_Property("V_Clk_A", 1, hls_out, 0, "bram", "mem_clk", 1),
	Port_Property("V_Rst_A", 1, hls_out, 0, "bram", "mem_rst", 1),
	Port_Property("U_1_Addr_A", 32, hls_out, 1, "bram", "MemPortADDR2", 1),
	Port_Property("U_1_EN_A", 1, hls_out, 1, "bram", "MemPortCE2", 1),
	Port_Property("U_1_WEN_A", 4, hls_out, 1, "bram", "MemPortWE2", 1),
	Port_Property("U_1_Din_A", 32, hls_out, 1, "bram", "MemPortDIN2", 1),
	Port_Property("U_1_Dout_A", 32, hls_in, 1, "bram", "MemPortDOUT2", 1),
	Port_Property("U_1_Clk_A", 1, hls_out, 1, "bram", "mem_clk", 1),
	Port_Property("U_1_Rst_A", 1, hls_out, 1, "bram", "mem_rst", 1),
...
const char* HLS_Design_Meta::dut_name = "hopfield_vitis";
