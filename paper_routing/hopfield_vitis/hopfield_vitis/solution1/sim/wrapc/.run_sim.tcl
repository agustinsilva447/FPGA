...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "hopfield_vitis.autotvin.dat"
	set constFileTvOut       "hopfield_vitis.autotvout.dat"
	set constFileHdlTvIn     "hopfield_vitis.autohdltvin.dat"
	set constFileHdlTvOut    "hopfield_vitis.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
