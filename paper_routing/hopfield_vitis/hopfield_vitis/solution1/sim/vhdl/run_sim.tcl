...
if {[file isfile hopfield_vitis.autotvin.dat]} {
	file delete -force hopfield_vitis.autotvin.dat
}

if {[file isfile hopfield_vitis.autotvout.dat]} {
	file delete -force hopfield_vitis.autotvout.dat
}
