...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.hopfield_vitis.autotvin_V.dat"
         "c.hopfield_vitis.autotvin_U_1.dat"
         "c.hopfield_vitis.autotvin_l.dat"
         "c.hopfield_vitis.autotvout_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.hopfield_vitis.autotvout_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
