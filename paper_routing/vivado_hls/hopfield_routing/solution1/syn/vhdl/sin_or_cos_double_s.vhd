...
architecture behav of sin_or_cos_double_s is 
    ...
    signal p_Val2_29_reg_1153 : STD_LOGIC_VECTOR (123 downto 0);
    signal ap_CS_fsm_state7 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state7 : signal is "none";
    signal trunc_ln_i_reg_1159 : STD_LOGIC_VECTOR (2 downto 0);
    signal p_Val2_30_fu_403_p3 : STD_LOGIC_VECTOR (2 downto 0);
    signal p_Val2_30_reg_1164 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_CS_fsm_state8 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state8 : signal is "none";
    signal p_Val2_7_fu_418_p3 : STD_LOGIC_VECTOR (123 downto 0);
    signal p_Val2_7_reg_1170 : STD_LOGIC_VECTOR (123 downto 0);
    ...
    signal do_cos_read_reg_1234 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal p_Val2_15_reg_1343 : STD_LOGIC_VECTOR (58 downto 0);
    signal trunc_ln1_reg_1348 : STD_LOGIC_VECTOR (55 downto 0);
    signal trunc_ln662_2_reg_1353 : STD_LOGIC_VECTOR (47 downto 0);
    ...
    signal p_Result_16_fu_435_p3 : STD_LOGIC_VECTOR (61 downto 0);
    signal p_Result_8_fu_442_p4 : STD_LOGIC_VECTOR (61 downto 0);
    signal p_Result_17_fu_452_p3 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal p_Result_18_fu_636_p3 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal p_Result_20_fu_911_p3 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal p_Result_19_fu_889_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal p_Result_21_fu_1085_p4 : STD_LOGIC_VECTOR (63 downto 0);
    signal bitcast_ln512_fu_1093_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    component hopfield_routing_ibs IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component hopfield_routing_jbC IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component hopfield_routing_kbM IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component hopfield_routing_lbW IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component hopfield_routing_mb6 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component hopfield_routing_ncg IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component hopfield_routing_ocq IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component hopfield_routing_pcA IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    ...
    hopfield_routing_ibs_U6 : component hopfield_routing_ibs
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 170,
    ...
    hopfield_routing_jbC_U7 : component hopfield_routing_jbC
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    hopfield_routing_kbM_U8 : component hopfield_routing_kbM
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 49,
    ...
    hopfield_routing_kbM_U9 : component hopfield_routing_kbM
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 49,
    ...
    hopfield_routing_kbM_U10 : component hopfield_routing_kbM
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 49,
    ...
    hopfield_routing_lbW_U11 : component hopfield_routing_lbW
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 56,
    ...
    hopfield_routing_mb6_U12 : component hopfield_routing_mb6
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 49,
    ...
    hopfield_routing_ncg_U13 : component hopfield_routing_ncg
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 42,
    ...
    hopfield_routing_ocq_U14 : component hopfield_routing_ocq
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 64,
    ...
    hopfield_routing_pcA_U15 : component hopfield_routing_pcA
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    hopfield_routing_pcA_U16 : component hopfield_routing_pcA
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state15)) then
                ...
                trunc_ln662_2_reg_1353 <= grp_fu_691_p2(92 downto 45);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state12)) then
                do_cos_read_reg_1234 <= (0=>do_cos, others=>'-');
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state8)) then
                p_Result_i_i_39_reg_1175 <= p_Val2_7_fu_418_p3(123 downto 63);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state7)) then
                p_Val2_29_reg_1153 <= grp_fu_372_p2(166 downto 43);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    Mx_bits_V_1_fu_413_p2 <= std_logic_vector(unsigned(ap_const_lv124_0) - unsigned(p_Val2_29_reg_1153));
    ...
    bitcast_ln512_fu_1093_p1 <= p_Result_21_fu_1085_p4;
    closepath_fu_300_p2 <= "1" when (unsigned(tmp_V_fu_286_p4) < unsigned(ap_const_lv11_3FE)) else "0";
    cos_basis_fu_815_p3 <= 
        xor_ln271_fu_810_p2 when (do_cos_read_reg_1234(0) = '1') else 
        tmp_reg_1240;
    ...
    p_Result_15_fu_358_p3 <= (ap_const_lv1_1 & tmp_V_1_reg_1110);
    p_Result_16_fu_435_p3 <= (p_Result_i_i_39_reg_1175 & ap_const_lv1_1);
    p_Result_17_fu_452_p3 <= (ap_const_lv2_3 & p_Result_8_fu_442_p4);
    p_Result_18_fu_636_p3 <= (sin_basis_fu_630_p2 & p_Result_i_reg_1219);
    p_Result_19_fu_889_p3 <= p_Val2_25_fu_885_p1(63 downto 63);
    p_Result_20_fu_911_p3 <= (p_Result_s_reg_1097 & p_Val2_30_reg_1164);
    p_Result_21_fu_1085_p4 <= ((p_Repl2_3_fu_1079_p3 & ret_V_9_reg_1435) & ret_V_10_reg_1440);
    
    p_Result_8_fu_442_p4_proc : process(p_Result_16_fu_435_p3)
    ...
    variable p_Result_8_fu_442_p4_i : integer;
    ...
    begin
        ...
        if (vlo_cpy(6 - 1 downto 0) > vhi_cpy(6 - 1 downto 0)) then
            ...
            for p_Result_8_fu_442_p4_i in 0 to 62-1 loop
                v0_cpy(p_Result_8_fu_442_p4_i) := p_Result_16_fu_435_p3(62-1-p_Result_8_fu_442_p4_i);
            end loop;
        end if;
        ...
        p_Result_8_fu_442_p4 <= resvalue(62-1 downto 0);
    end process;
    ...
    r_V_18_fu_487_p2 <= std_logic_vector(shift_left(unsigned(p_Val2_7_reg_1170),to_integer(unsigned('0' & zext_ln1253_fu_484_p1(31-1 downto 0)))));
    r_V_19_fu_563_p3 <= 
    ...
    select_ln307_fu_1004_p3 <= 
        ap_const_lv11_3FF when (do_cos_read_reg_1234(0) = '1') else 
        ap_const_lv11_0;
    select_ln311_1_fu_1029_p3 <= 
    ...
    select_ln482_fu_477_p3 <= 
        ...
        sext_ln657_fu_791_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln662_2_reg_1353),64));
    ...
    t1_V_fu_737_p3 <= (p_Val2_15_reg_1343 & ap_const_lv4_0);
    tmp_V_1_fu_296_p1 <= p_Val2_s_fu_274_p1(52 - 1 downto 0);
    tmp_V_2_fu_897_p4 <= p_Val2_25_fu_885_p1(62 downto 52);
    tmp_V_3_fu_907_p1 <= p_Val2_25_fu_885_p1(52 - 1 downto 0);
    tmp_V_fu_286_p4 <= p_Val2_s_fu_274_p1(62 downto 52);
    
    tmp_i_i_fu_460_p3_proc : process(p_Result_17_fu_452_p3)
    begin
        tmp_i_i_fu_460_p3 <= std_logic_vector(to_unsigned(64, 64));
        for i in 0 to 64 - 1 loop
            if p_Result_17_fu_452_p3(i) = '1' then
    ...
    trunc_ln745_fu_409_p1 <= p_Val2_30_fu_403_p3(1 - 1 downto 0);
    ush_fu_538_p3 <= 
    ...
    zext_ln498_fu_643_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_Result_18_fu_636_p3),64));
