...
// ==============================================================
#ifndef __hopfield_routing_ocq__HH__
#define __hopfield_routing_ocq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(hopfield_routing_ocq) {
    ...
    SC_CTOR(hopfield_routing_ocq):  ACMP_mul_su_U ("ACMP_mul_su_U") {
