...
// ==============================================================
#ifndef __hopfield_routing_ibs__HH__
#define __hopfield_routing_ibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(hopfield_routing_ibs) {
    ...
    SC_CTOR(hopfield_routing_ibs):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
