...
// ==============================================================
#ifndef __hopfield_routing_qcK__HH__
#define __hopfield_routing_qcK__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(hopfield_routing_qcK) {
    ...
    SC_CTOR(hopfield_routing_qcK):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
