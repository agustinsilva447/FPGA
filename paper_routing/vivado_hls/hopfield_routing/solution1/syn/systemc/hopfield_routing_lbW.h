...
// ==============================================================
#ifndef __hopfield_routing_lbW__HH__
#define __hopfield_routing_lbW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(hopfield_routing_lbW) {
    ...
    SC_CTOR(hopfield_routing_lbW):  ACMP_mul_us_U ("ACMP_mul_us_U") {
