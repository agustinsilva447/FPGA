...
// ==============================================================
#ifndef __hopfield_routing_ncg__HH__
#define __hopfield_routing_ncg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(hopfield_routing_ncg) {
    ...
    SC_CTOR(hopfield_routing_ncg):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
