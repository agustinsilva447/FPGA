...
// ==============================================================
#ifndef __hopfield_routing_tde__HH__
#define __hopfield_routing_tde__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(hopfield_routing_tde) {
    ...
    SC_CTOR(hopfield_routing_tde):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
