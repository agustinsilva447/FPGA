...
// ==============================================================
#ifndef __hopfield_routing_kbM__HH__
#define __hopfield_routing_kbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(hopfield_routing_kbM) {
    ...
    SC_CTOR(hopfield_routing_kbM):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
