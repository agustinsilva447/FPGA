...
// ==============================================================
#ifndef __hnn_fpga_fpext_32dEe__HH__
#define __hnn_fpga_fpext_32dEe__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(hnn_fpga_fpext_32dEe) {
    ...
    SC_CTOR(hnn_fpga_fpext_32dEe):  ACMP_fpext_U ("ACMP_fpext_U") {
