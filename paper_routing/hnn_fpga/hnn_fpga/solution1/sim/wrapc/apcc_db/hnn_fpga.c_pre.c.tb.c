...
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge3 = phi i32 [ 0, %%0 ], [ %%24, %%23  for 0x%I64xth hint within @hnn_fpga  --> \n", ++aesl_llvm_cbe_storemerge3_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = shl i32 %%storemerge3, 3, !dbg !4 for 0x%I64xth hint within @hnn_fpga  --> \n", ++aesl_llvm_cbe_20_count);
...
llvm_cbe_tmp__20:
if (AESL_DEBUG_TRACE)
printf("\n  %%24 = add nsw i32 %%storemerge3, 1, !dbg !4 for 0x%I64xth hint within @hnn_fpga  --> \n", ++aesl_llvm_cbe_54_count);
...
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__18&4294967295ull)));
  if (((llvm_cbe_tmp__18&4294967295U) == (8u&4294967295U))) {
...
llvm_cbe_tmp__19:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge12 = phi i32 [ 0, %%.preheader ], [ %%22, %%21  for 0x%I64xth hint within @hnn_fpga  --> \n", ++aesl_llvm_cbe_storemerge12_count);
...
llvm_cbe_tmp__24:
if (AESL_DEBUG_TRACE)
printf("\n  %%22 = add nsw i32 %%storemerge12, 1, !dbg !4 for 0x%I64xth hint within @hnn_fpga  --> \n", ++aesl_llvm_cbe_46_count);
...
llvm_cbe_tmp__22:
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = add nsw i32 %%storemerge3, %%1, !dbg !4 for 0x%I64xth hint within @hnn_fpga  --> \n", ++aesl_llvm_cbe_24_count);
  llvm_cbe_tmp__2 = (unsigned int )((unsigned int )(llvm_cbe_storemerge3&4294967295ull)) + ((unsigned int )(llvm_cbe_tmp__1&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__2&4294967295ull)));
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = sext i32 %%5 to i64, !dbg !4 for 0x%I64xth hint within @hnn_fpga  --> \n", ++aesl_llvm_cbe_25_count);
...
llvm_cbe_tmp__23:
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = add nsw i32 %%storemerge12, %%1, !dbg !4 for 0x%I64xth hint within @hnn_fpga  --> \n", ++aesl_llvm_cbe_29_count);
  llvm_cbe_tmp__5 = (unsigned int )((unsigned int )(llvm_cbe_storemerge12&4294967295ull)) + ((unsigned int )(llvm_cbe_tmp__1&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__5&4294967295ull)));
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = sext i32 %%9 to i64, !dbg !2 for 0x%I64xth hint within @hnn_fpga  --> \n", ++aesl_llvm_cbe_33_count);
  llvm_cbe_tmp__6 = (unsigned long long )((signed long long )(signed int )llvm_cbe_tmp__5);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__6);
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = getelementptr inbounds float* %%U, i64 %%10, !dbg !2 for 0x%I64xth hint within @hnn_fpga  --> \n", ++aesl_llvm_cbe_34_count);
  llvm_cbe_tmp__7 = (float *)(&llvm_cbe_U[(((signed long long )llvm_cbe_tmp__6))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__6));
}
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = load float* %%11, align 4, !dbg !2 for 0x%I64xth hint within @hnn_fpga  --> \n", ++aesl_llvm_cbe_35_count);
  llvm_cbe_tmp__8 = (float )*llvm_cbe_tmp__7;
if (AESL_DEBUG_TRACE)
printf("\n = %f,  0x%x\n", llvm_cbe_tmp__8, *(int*)(&llvm_cbe_tmp__8));
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = fsub float -0.000000e+00, %%12, !dbg !2 for 0x%I64xth hint within @hnn_fpga  --> \n", ++aesl_llvm_cbe_36_count);
  llvm_cbe_tmp__9 = (float )((float )(-(llvm_cbe_tmp__8)));
if (AESL_DEBUG_TRACE)
printf("\n = %f,  0x%x\n", llvm_cbe_tmp__9, *(int*)(&llvm_cbe_tmp__9));
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = fmul float %%l, %%13, !dbg !2 for 0x%I64xth hint within @hnn_fpga  --> \n", ++aesl_llvm_cbe_37_count);
  llvm_cbe_tmp__10 = (float )((float )(llvm_cbe_l * llvm_cbe_tmp__9));
if (AESL_DEBUG_TRACE)
printf("\n = %f,  0x%x\n", llvm_cbe_tmp__10, *(int*)(&llvm_cbe_tmp__10));
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = fpext float %%14 to double, !dbg !2 for 0x%I64xth hint within @hnn_fpga  --> \n", ++aesl_llvm_cbe_38_count);
  llvm_cbe_tmp__11 = (double )((double )llvm_cbe_tmp__10);
if (AESL_DEBUG_TRACE)
printf("\n = %lf,  0x%llx\n", llvm_cbe_tmp__11, *(long long*)(&llvm_cbe_tmp__11));
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = tail call double @exp(double %%15) nounwind, !dbg !2 for 0x%I64xth hint within @hnn_fpga  --> \n", ++aesl_llvm_cbe_39_count);
  llvm_cbe_tmp__12 = (double ) /*tail*/ exp(llvm_cbe_tmp__11);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = %lf,  0x%llx",llvm_cbe_tmp__11, *(long long*)(&llvm_cbe_tmp__11));
printf("\nReturn  = %lf",llvm_cbe_tmp__12);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = fadd double %%16, 1.000000e+00, !dbg !2 for 0x%I64xth hint within @hnn_fpga  --> \n", ++aesl_llvm_cbe_40_count);
  llvm_cbe_tmp__13 = (double )llvm_cbe_tmp__12 + 0x1p0;
if (AESL_DEBUG_TRACE)
printf("\n = %lf,  0x%llx\n", llvm_cbe_tmp__13, *(long long*)(&llvm_cbe_tmp__13));
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = fdiv double 1.000000e+00, %%17, !dbg !2 for 0x%I64xth hint within @hnn_fpga  --> \n", ++aesl_llvm_cbe_41_count);
  llvm_cbe_tmp__14 = (double )0x1p0 / llvm_cbe_tmp__13;
if (AESL_DEBUG_TRACE)
printf("\n = %lf,  0x%llx\n", llvm_cbe_tmp__14, *(long long*)(&llvm_cbe_tmp__14));
if (AESL_DEBUG_TRACE)
printf("\n  %%19 = fptrunc double %%18 to float, !dbg !2 for 0x%I64xth hint within @hnn_fpga  --> \n", ++aesl_llvm_cbe_42_count);
  llvm_cbe_tmp__15 = (float )((float )llvm_cbe_tmp__14);
if (AESL_DEBUG_TRACE)
printf("\n = %f,  0x%x\n", llvm_cbe_tmp__15, *(int*)(&llvm_cbe_tmp__15));
if (AESL_DEBUG_TRACE)
printf("\n  %%20 = getelementptr inbounds float* %%V, i64 %%10, !dbg !2 for 0x%I64xth hint within @hnn_fpga  --> \n", ++aesl_llvm_cbe_43_count);
  llvm_cbe_tmp__16 = (float *)(&llvm_cbe_V[(((signed long long )llvm_cbe_tmp__6))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__6));
}
if (AESL_DEBUG_TRACE)
printf("\n  store float %%19, float* %%20, align 4, !dbg !2 for 0x%I64xth hint within @hnn_fpga  --> \n", ++aesl_llvm_cbe_44_count);
