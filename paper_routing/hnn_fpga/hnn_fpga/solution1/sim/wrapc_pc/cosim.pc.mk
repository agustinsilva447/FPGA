...
$(ObjDir)/hnn_fpga_terminate.c_pre.c.tb.o : hnn_fpga_terminate.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) hnn_fpga_terminate.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/hnn_fpga_initialize.c_pre.c.tb.o : hnn_fpga_initialize.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) hnn_fpga_initialize.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/hnn_fpga.c_pre.c.tb.o : hnn_fpga.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) hnn_fpga.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
