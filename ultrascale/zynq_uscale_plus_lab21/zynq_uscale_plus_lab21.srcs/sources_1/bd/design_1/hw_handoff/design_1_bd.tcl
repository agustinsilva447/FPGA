...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__PROTECTION__SUBSYSTEMS {APU:APU|RPU:RPU0|Secure Subsystem:|PMU Firmware:PMU} \
