# 1 "C:/Users/aguss/Desktop/Github/FPGA/ultrascale/VQFTAXIBUS/VQFTAXIBUS.c"
# 1 "C:/Users/aguss/Desktop/Github/FPGA/ultrascale/VQFTAXIBUS/VQFTAXIBUS.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/aguss/Desktop/Github/FPGA/ultrascale/VQFTAXIBUS/VQFTAXIBUS.c" 2
...
#pragma pack(pop)
# 2 "C:/Users/aguss/Desktop/Github/FPGA/ultrascale/VQFTAXIBUS/VQFTAXIBUS.c" 2



void VQFTAXIBUS(const float E[2*16], float S[2*16])
{
...
#pragma HLS UNROLL
 S[j]=0;
  ...
  {
#pragma HLS UNROLL
 m = cos(6.282958984375*j*k/16)/sqrt(16);
   n = sin(6.282958984375*j*k/16)/sqrt(16);
   S[j] = S[j] + (m) * E[k] - (n) * E[k+16];
   S[j+16] = S[j+16] + (m) * E[k+16] + (n) * E[k];
  }
 }
}
