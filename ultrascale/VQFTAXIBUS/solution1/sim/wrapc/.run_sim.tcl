...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "VQFTAXIBUS.autotvin.dat"
	set constFileTvOut       "VQFTAXIBUS.autotvout.dat"
	set constFileHdlTvIn     "VQFTAXIBUS.autohdltvin.dat"
	set constFileHdlTvOut    "VQFTAXIBUS.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
