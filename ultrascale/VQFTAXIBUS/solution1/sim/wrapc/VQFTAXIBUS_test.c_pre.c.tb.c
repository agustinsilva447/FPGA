...
// ==============================================================
# 1 "C:/Users/aguss/Desktop/Github/FPGA/ultrascale/VQFTAXIBUS/VQFTAXIBUS_test.c"
# 1 "C:/Users/aguss/Desktop/Github/FPGA/ultrascale/VQFTAXIBUS/VQFTAXIBUS_test.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/aguss/Desktop/Github/FPGA/ultrascale/VQFTAXIBUS/VQFTAXIBUS_test.c" 2
...
# 2 "C:/Users/aguss/Desktop/Github/FPGA/ultrascale/VQFTAXIBUS/VQFTAXIBUS_test.c" 2
...
#pragma pack(pop)
# 3 "C:/Users/aguss/Desktop/Github/FPGA/ultrascale/VQFTAXIBUS/VQFTAXIBUS_test.c" 2





void VQFTAXIBUS(float E[2*2*2*2*2], float S[2*2*2*2*2]);

    #ifndef HLS_FASTSIM
#ifndef HLS_FASTSIM
#include "apatb_VQFTAXIBUS.h"
#endif
# 10 "C:/Users/aguss/Desktop/Github/FPGA/ultrascale/VQFTAXIBUS/VQFTAXIBUS_test.c"
int main ()
    {
     int j;
     float P[2*2*4];
     ...
     E[8]=0; E[8+2*2*2*2]=0;
     E[9]=0; E[9+2*2*2*2]=0;
     E[10]=0; E[10+2*2*2*2]=0;
     E[11]=0; E[11+2*2*2*2]=0;
     E[12]=0; E[12+2*2*2*2]=0;
     E[13]=0; E[13+2*2*2*2]=0;
     E[14]=0; E[14+2*2*2*2]=0;
     E[15]=0; E[15+2*2*2*2]=0;

     
#ifndef HLS_FASTSIM
#define VQFTAXIBUS AESL_WRAP_VQFTAXIBUS
#endif
# 34 "C:/Users/aguss/Desktop/Github/FPGA/ultrascale/VQFTAXIBUS/VQFTAXIBUS_test.c"
VQFTAXIBUS(E,S);
#undef VQFTAXIBUS
# 34 "C:/Users/aguss/Desktop/Github/FPGA/ultrascale/VQFTAXIBUS/VQFTAXIBUS_test.c"
     ...
     printf("\nE = \n");
        for (j=0;j<2*2*2*2;j++)
     {
     printf("%f + i* %f\n",(float)E[j],(float)E[j+2*2*2*2]);
     }

     printf("\nS = \n");
     for (j=0;j<2*2*2*2;j++)
     {
     printf("%f + i* %f\n",(float)S[j],(float)S[j+2*2*2*2]);
     }
        return 0;
    }
#endif
# 48 "C:/Users/aguss/Desktop/Github/FPGA/ultrascale/VQFTAXIBUS/VQFTAXIBUS_test.c"
