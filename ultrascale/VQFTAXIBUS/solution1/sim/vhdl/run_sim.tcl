...
if {[file isfile VQFTAXIBUS.autotvin.dat]} {
	file delete -force VQFTAXIBUS.autotvin.dat
}

if {[file isfile VQFTAXIBUS.autotvout.dat]} {
	file delete -force VQFTAXIBUS.autotvout.dat
}
