# 1 "VQFTAXIBUS/VQFTAXIBUS.c"
# 1 "VQFTAXIBUS/VQFTAXIBUS.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
#pragma pack(pop)
# 2 "VQFTAXIBUS/VQFTAXIBUS.c" 2



void VQFTAXIBUS(const float E[2*16], float S[2*16])
{_ssdm_SpecArrayDimSize(E, 32);_ssdm_SpecArrayDimSize(S, 32);
_ssdm_op_SpecInterface(E, "s_axilite", 0, 0, "", 0, 0, "", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(S, "s_axilite", 0, 0, "", 0, 0, "", "", "", 0, 0, 0, 0, "", "");
