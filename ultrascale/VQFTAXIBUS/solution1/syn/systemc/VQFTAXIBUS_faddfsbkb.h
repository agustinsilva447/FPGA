...
// ==============================================================
#ifndef __VQFTAXIBUS_faddfsbkb__HH__
#define __VQFTAXIBUS_faddfsbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(VQFTAXIBUS_faddfsbkb) {
    ...
    SC_CTOR(VQFTAXIBUS_faddfsbkb):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
