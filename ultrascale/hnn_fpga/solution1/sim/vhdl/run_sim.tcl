...
if {[file isfile hnn_fpga.autotvin.dat]} {
	file delete -force hnn_fpga.autotvin.dat
}

if {[file isfile hnn_fpga.autotvout.dat]} {
	file delete -force hnn_fpga.autotvout.dat
}
