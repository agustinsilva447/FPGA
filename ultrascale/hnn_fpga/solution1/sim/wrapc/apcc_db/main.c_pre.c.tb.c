...
if (AESL_DEBUG_TRACE)
printf("\n  call void @AESL_WRAP_hnn_fpga(float* %%66, float 6.000000e+00, float* %%67) nounwind, !dbg !12 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_1243_count);
  AESL_WRAP_hnn_fpga((float *)llvm_cbe_tmp__444, 0x1.8p2, (float *)llvm_cbe_tmp__445);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = %f",0x1.8p2);
}
if (AESL_DEBUG_TRACE)
