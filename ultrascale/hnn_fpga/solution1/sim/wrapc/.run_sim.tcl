...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "hnn_fpga.autotvin.dat"
	set constFileTvOut       "hnn_fpga.autotvout.dat"
	set constFileHdlTvIn     "hnn_fpga.autohdltvin.dat"
	set constFileHdlTvOut    "hnn_fpga.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
