...
// ==============================================================
#ifndef __hnn_fpga_fptrunc_cud__HH__
#define __hnn_fpga_fptrunc_cud__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(hnn_fpga_fptrunc_cud) {
    ...
    SC_CTOR(hnn_fpga_fptrunc_cud):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
