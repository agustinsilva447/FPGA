...
HD_PWD='C:/Users/aguss/Desktop/Github/FPGA/ultrascale/hnn_fpga/hnn_fpga/hnn_fpga.runs/hnn_fpga_auto_ds_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hnn_fpga_auto_ds_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hnn_fpga_auto_ds_0.tcl
