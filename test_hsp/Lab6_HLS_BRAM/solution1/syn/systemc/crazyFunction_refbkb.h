...
// ==============================================================
#ifndef __crazyFunction_refbkb_H__
#define __crazyFunction_refbkb_H__
...
struct crazyFunction_refbkb_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(crazyFunction_refbkb_ram) {
...
SC_MODULE(crazyFunction_refbkb) {
...
crazyFunction_refbkb_ram* meminst;


SC_CTOR(crazyFunction_refbkb) {
meminst = new crazyFunction_refbkb_ram("crazyFunction_refbkb_ram");
