...
// ==============================================================
#ifndef __crazyFunction_mulmb6__HH__
#define __crazyFunction_mulmb6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(crazyFunction_mulmb6) {
    ...
    SC_CTOR(crazyFunction_mulmb6):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
