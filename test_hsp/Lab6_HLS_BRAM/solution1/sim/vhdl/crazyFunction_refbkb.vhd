...
entity crazyFunction_refbkb_rom is 
    generic(
             DWIDTH     : integer := 100; 
             AWIDTH     : integer := 4; 
             MEM_SIZE    : integer := 13
...
architecture rtl of crazyFunction_refbkb_rom is 
...
entity crazyFunction_refbkb is
    generic (
...
architecture arch of crazyFunction_refbkb is
    component crazyFunction_refbkb_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    crazyFunction_refbkb_rom_U :  component crazyFunction_refbkb_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
