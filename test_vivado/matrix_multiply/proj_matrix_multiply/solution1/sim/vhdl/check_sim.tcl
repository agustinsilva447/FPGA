...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.matrix_multiply_top.autotvin_A.dat"
         "c.matrix_multiply_top.autotvin_B.dat"
         "c.matrix_multiply_top.autotvin_C.dat"
         "c.matrix_multiply_top.autotvout_C.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.matrix_multiply_top.autotvout_C.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
