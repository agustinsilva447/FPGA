...
set ID 23
set hasByteEnable 0
set MemName crazyFunction_refbkb
...
set ID 24
set hasByteEnable 0
set MemName crazyFunction_seccud
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 30
set AddrRange 256
...
set ID 25
set hasByteEnable 0
set MemName crazyFunction_secdEe
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 23
set AddrRange 256
...
set ID 26
set hasByteEnable 0
set MemName crazyFunction_seceOg
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 15
set AddrRange 256
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler crazyFunction_CRTL_BUS_s_axi
}
