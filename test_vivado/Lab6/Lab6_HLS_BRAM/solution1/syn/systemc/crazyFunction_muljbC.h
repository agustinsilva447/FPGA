...
// ==============================================================
#ifndef __crazyFunction_muljbC__HH__
#define __crazyFunction_muljbC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(crazyFunction_muljbC) {
    ...
    SC_CTOR(crazyFunction_muljbC):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
