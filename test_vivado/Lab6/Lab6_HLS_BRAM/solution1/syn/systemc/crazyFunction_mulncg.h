...
// ==============================================================
#ifndef __crazyFunction_mulncg__HH__
#define __crazyFunction_mulncg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(crazyFunction_mulncg) {
    ...
    SC_CTOR(crazyFunction_mulncg):  ACMP_smul_us_U ("ACMP_smul_us_U") {
