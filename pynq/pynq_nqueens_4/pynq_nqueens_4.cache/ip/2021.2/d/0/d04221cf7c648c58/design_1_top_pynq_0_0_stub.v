...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, nRst, count, done)
/* synthesis syn_black_box black_box_pad_pin="clk,nRst,count[9:0],done" */;
  input clk;
  input nRst;
  output [9:0]count;
  output done;
