...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXIL is
  port (
    ...
    axil_rdata : out STD_LOGIC_VECTOR ( 9 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXIL is
  ...
  signal reg_rd_dat : STD_LOGIC_VECTOR ( 9 downto 0 );
  ...
  attribute SOFT_HLUTNM of \axi_rdata[9]_i_3\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of axi_wready_i_1 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \regs_out[0][0]_i_3\ : label is "soft_lutpair1";
begin
...
\regs_out[0][0]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0004"
    )
        port map (
...
AXIL_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXIL
     port map (
      ...
      axil_bvalid => axil_bvalid,
      axil_rdata(9 downto 0) => axil_rdata(9 downto 0),
      axil_rready => axil_rready,
      axil_rvalid => axil_rvalid,
      axil_wdata(0) => axil_wdata(0),
      \axil_wdata[0]_0\ => AXIL_inst_n_6,
      axil_wdata_0_sp_1 => AXIL_inst_n_5,
      axil_wvalid => axil_wvalid,
      reg0_i(9 downto 0) => reg0_i(9 downto 0),
      reg0_o(0) => \^reg0_o\(0),
      reg1_i(9 downto 0) => reg1_i(9 downto 0),
      reg1_o(0) => \^reg1_o\(0)
    );
comblock_i: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ComBlock
     port map (
      ...
      \regs_out_reg[1][0]_0\ => AXIL_inst_n_6
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal \^axil_rdata\ : STD_LOGIC_VECTOR ( 9 downto 0 );
