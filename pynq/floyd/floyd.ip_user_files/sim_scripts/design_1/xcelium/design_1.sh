...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../floyd.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../floyd.gen/sources_1/bd/design_1/ipshared/3007/hdl" \
       +incdir+"../../../../floyd.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../floyd.gen/sources_1/bd/design_1/ipshared/3007/hdl" \
