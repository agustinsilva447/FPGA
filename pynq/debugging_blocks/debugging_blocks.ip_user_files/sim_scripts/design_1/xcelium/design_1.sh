...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../debugging_blocks.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../debugging_blocks.gen/sources_1/bd/design_1/ipshared/3007/hdl" \
       +incdir+"../../../../debugging_blocks.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../debugging_blocks.gen/sources_1/bd/design_1/ipshared/3007/hdl" \
       +incdir+"/home/agustinsilva447/Vitis/Vivado/2021.2/data/xilinx_vip/include"
}
