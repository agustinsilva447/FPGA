...
HD_PWD='/home/agustinsilva447/Escritorio/Github/FPGA/pynq/pynq_nqueens_3/pynq_nqueens_3.runs/design_1_fsm_block_0_6_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_fsm_block_0_6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_fsm_block_0_6.tcl
