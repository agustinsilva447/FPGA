...
-- Date        : Tue Jan 25 18:44:20 2022
-- Host        : agustinsilva447-Lenovo-G50-80 running 64-bit Ubuntu 20.04.3 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/agustinsilva447/Escritorio/Github/FPGA/pynq/pynq_nqueens_3/pynq_nqueens_3.gen/sources_1/bd/design_1/ip/design_1_fsm_block_0_5/design_1_fsm_block_0_5_sim_netlist.vhdl
-- Design      : design_1_fsm_block_0_5
...
entity design_1_fsm_block_0_5_ctrl_logic is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_fsm_block_0_5_ctrl_logic : entity is "ctrl_logic";
end design_1_fsm_block_0_5_ctrl_logic;

architecture STRUCTURE of design_1_fsm_block_0_5_ctrl_logic is
  ...
  attribute SOFT_HLUTNM of \j[0]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \j[1]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \j[2]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \j[3]_i_2\ : label is "soft_lutpair5";
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_fsm_block_0_5_up_counter is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_fsm_block_0_5_up_counter : entity is "up_counter";
end design_1_fsm_block_0_5_up_counter;

architecture STRUCTURE of design_1_fsm_block_0_5_up_counter is
  ...
  attribute SOFT_HLUTNM of \count[3]_i_17\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of done_aux_i_16 : label is "soft_lutpair1";
begin
  AR(0) <= \^ar\(0);
...
\count[3]_i_11\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFF4182"
    )
        port map (
...
done_aux_i_10: unisim.vcomponents.LUT5
    generic map(
      INIT => X"BE7D0000"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_fsm_block_0_5_fsm_block is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_fsm_block_0_5_fsm_block : entity is "fsm_block";
end design_1_fsm_block_0_5_fsm_block;

architecture STRUCTURE of design_1_fsm_block_0_5_fsm_block is
  signal \FSM_onehot_state_reg_n_0_[0]\ : STD_LOGIC;
  signal \FSM_onehot_state_reg_n_0_[2]\ : STD_LOGIC;
  signal \^q\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal acks_out : STD_LOGIC;
  signal \asout_array[5]_0\ : STD_LOGIC;
  signal ce : STD_LOGIC;
...
logic: entity work.design_1_fsm_block_0_5_ctrl_logic
     port map (
      AR(0) => reset_control,
      D(1) => logic_n_4,
      D(0) => logic_n_5,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_fsm_block_0_5 is
  port (
    clk : in STD_LOGIC;
    nRst : in STD_LOGIC;
    a_in : in STD_LOGIC_VECTOR ( 19 downto 0 );
  ...
  attribute NotValidForBitStream of design_1_fsm_block_0_5 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_fsm_block_0_5 : entity is "design_1_fsm_block_0_5,fsm_block,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_fsm_block_0_5 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of design_1_fsm_block_0_5 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of design_1_fsm_block_0_5 : entity is "fsm_block,Vivado 2021.2";
end design_1_fsm_block_0_5;

architecture STRUCTURE of design_1_fsm_block_0_5 is
...
begin
U0: entity work.design_1_fsm_block_0_5_fsm_block
     port map (
      Q(0) => output_state(2),
      a_in(19 downto 0) => a_in(19 downto 0),
      a_out(23 downto 0) => a_out(23 downto 0),
      ack_in => ack_in,
      ack_out => ack_out,
      clk => clk,
      nRst => nRst,
