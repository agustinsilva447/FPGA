...
-- Date        : Tue Jan 25 18:44:19 2022
-- Host        : agustinsilva447-Lenovo-G50-80 running 64-bit Ubuntu 20.04.3 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/agustinsilva447/Escritorio/Github/FPGA/pynq/pynq_nqueens_3/pynq_nqueens_3.gen/sources_1/bd/design_1/ip/design_1_fsm_block_0_6/design_1_fsm_block_0_6_sim_netlist.vhdl
...
entity design_1_fsm_block_0_6_ctrl_logic is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_fsm_block_0_6_ctrl_logic : entity is "ctrl_logic";
end design_1_fsm_block_0_6_ctrl_logic;

architecture STRUCTURE of design_1_fsm_block_0_6_ctrl_logic is
  ...
  attribute SOFT_HLUTNM of done_aux_i_2 : label is "soft_lutpair3";
...
done_aux_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4F4A"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_fsm_block_0_6_up_counter is
  port (
    a_in_11_sp_1 : out STD_LOGIC;
    Q : out STD_LOGIC_VECTOR ( 3 downto 0 );
    \j_reg[2]\ : out STD_LOGIC;
    \j_reg[2]_0\ : out STD_LOGIC;
    \a_in[11]_0\ : out STD_LOGIC;
    a_in_15_sp_1 : out STD_LOGIC;
    D : out STD_LOGIC_VECTOR ( 1 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_fsm_block_0_6_up_counter : entity is "up_counter";
end design_1_fsm_block_0_6_up_counter;

architecture STRUCTURE of design_1_fsm_block_0_6_up_counter is
  signal \^ar\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal \^q\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal a_in_11_sn_1 : STD_LOGIC;
  signal a_in_15_sn_1 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \count[3]_i_10\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \count_reg_reg[0]_i_1\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \count_reg_reg[2]_i_1\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \count_reg_reg[3]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of done_aux_i_10 : label is "soft_lutpair1";
begin
  AR(0) <= \^ar\(0);
  Q(3 downto 0) <= \^q\(3 downto 0);
  a_in_11_sp_1 <= a_in_11_sn_1;
  a_in_15_sp_1 <= a_in_15_sn_1;
...
\count[3]_i_11\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"ED48"
    )
        port map (
...
\count[3]_i_12\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"ED48"
    )
        port map (
...
\count[3]_i_13\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"ED48"
    )
        port map (
...
\count[3]_i_14\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"ED48"
    )
        port map (
...
\count[3]_i_7\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFF4182"
    )
        port map (
...
done_aux_i_11: unisim.vcomponents.LUT4
    generic map(
      INIT => X"ED48"
    )
        port map (
...
done_aux_i_12: unisim.vcomponents.LUT4
    generic map(
      INIT => X"ED48"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_fsm_block_0_6_fsm_block is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_fsm_block_0_6_fsm_block : entity is "fsm_block";
end design_1_fsm_block_0_6_fsm_block;

architecture STRUCTURE of design_1_fsm_block_0_6_fsm_block is
  signal \FSM_onehot_state_reg_n_0_[0]\ : STD_LOGIC;
  signal \FSM_onehot_state_reg_n_0_[2]\ : STD_LOGIC;
  signal \^q\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal acks_out : STD_LOGIC;
  signal \asout_array[6]_0\ : STD_LOGIC;
  signal ce : STD_LOGIC;
  ...
  signal j_reg : STD_LOGIC_VECTOR ( 2 downto 0 );
...
dut: entity work.design_1_fsm_block_0_6_up_counter
     port map (
      AR(0) => reset_counter,
      D(1) => dut_n_9,
      D(0) => dut_n_10,
      \FSM_onehot_state_reg[3]\ => dut_n_11,
      \FSM_onehot_state_reg[4]\(2) => \asout_array[6]_0\,
      ...
      ce => ce,
      clk => clk,
      done_aux_reg(1) => j_reg(2),
      done_aux_reg(0) => j_reg(0),
      \j_reg[2]\ => dut_n_5,
      \j_reg[2]_0\ => dut_n_6,
      nRst => nRst
    );
logic: entity work.design_1_fsm_block_0_6_ctrl_logic
     port map (
      AR(0) => reset_control,
      D(1) => logic_n_4,
      D(0) => logic_n_5,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_fsm_block_0_6 is
  port (
    clk : in STD_LOGIC;
    nRst : in STD_LOGIC;
    a_in : in STD_LOGIC_VECTOR ( 23 downto 0 );
  ...
  attribute NotValidForBitStream of design_1_fsm_block_0_6 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_fsm_block_0_6 : entity is "design_1_fsm_block_0_6,fsm_block,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_fsm_block_0_6 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of design_1_fsm_block_0_6 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of design_1_fsm_block_0_6 : entity is "fsm_block,Vivado 2021.2";
end design_1_fsm_block_0_6;

architecture STRUCTURE of design_1_fsm_block_0_6 is
...
begin
U0: entity work.design_1_fsm_block_0_6_fsm_block
     port map (
      Q(0) => output_state(2),
      a_in(23 downto 0) => a_in(23 downto 0),
      a_out(27 downto 0) => a_out(27 downto 0),
      ack_in => ack_in,
      ack_out => ack_out,
      clk => clk,
      nRst => nRst,
