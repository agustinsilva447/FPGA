...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("E_Addr_A", 32, hls_out, 0, "bram", "mem_address", 1),
	Port_Property("E_EN_A", 1, hls_out, 0, "bram", "mem_ce", 1),
	Port_Property("E_WEN_A", 4, hls_out, 0, "bram", "mem_we", 1),
	Port_Property("E_Din_A", 32, hls_out, 0, "bram", "mem_din", 1),
	Port_Property("E_Dout_A", 32, hls_in, 0, "bram", "mem_dout", 1),
	Port_Property("E_Clk_A", 1, hls_out, 0, "bram", "mem_clk", 1),
	Port_Property("E_Rst_A", 1, hls_out, 0, "bram", "mem_rst", 1),
	Port_Property("S_Addr_A", 32, hls_out, 1, "bram", "mem_address", 1),
	Port_Property("S_EN_A", 1, hls_out, 1, "bram", "mem_ce", 1),
	Port_Property("S_WEN_A", 4, hls_out, 1, "bram", "mem_we", 1),
	Port_Property("S_Din_A", 32, hls_out, 1, "bram", "mem_din", 1),
	Port_Property("S_Dout_A", 32, hls_in, 1, "bram", "mem_dout", 1),
	Port_Property("S_Clk_A", 1, hls_out, 1, "bram", "mem_clk", 1),
	Port_Property("S_Rst_A", 1, hls_out, 1, "bram", "mem_rst", 1),
