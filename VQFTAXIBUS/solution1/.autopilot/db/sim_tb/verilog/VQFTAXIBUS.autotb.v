...
`define AUTOTB_DUT      VQFTAXIBUS
`define AUTOTB_DUT_INST AESL_inst_VQFTAXIBUS
`define AUTOTB_TOP      apatb_VQFTAXIBUS_top
`define AUTOTB_LAT_RESULT_FILE "VQFTAXIBUS.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "VQFTAXIBUS.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_VQFTAXIBUS_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_BRAM_E AESL_autobram_E
`define AESL_BRAM_INST_E bram_inst_E
`define AESL_BRAM_S AESL_autobram_S
`define AESL_BRAM_INST_S bram_inst_S
`define AUTOTB_TVIN_E  "./c.VQFTAXIBUS.autotvin_E.dat"
`define AUTOTB_TVIN_S  "./c.VQFTAXIBUS.autotvin_S.dat"
`define AUTOTB_TVIN_E_out_wrapc  "./rtl.VQFTAXIBUS.autotvin_E.dat"
`define AUTOTB_TVIN_S_out_wrapc  "./rtl.VQFTAXIBUS.autotvin_S.dat"
`define AUTOTB_TVOUT_S  "./c.VQFTAXIBUS.autotvout_S.dat"
`define AUTOTB_TVOUT_S_out_wrapc  "./impl_rtl.VQFTAXIBUS.autotvout_S.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 196;
parameter LENGTH_E = 32;
parameter LENGTH_S = 32;
...
assign E_DOUT_A = bramE_Dout_A;
assign bramE_WEN_A = 0;
assign bramE_Din_A = 0;
assign bramE_ready=    ready;
assign bramE_done = 0;


//------------------------bramS Instantiation--------------

// The input and output of bramS
wire  bramS_Clk_A, bramS_Clk_B;
wire  bramS_EN_A, bramS_EN_B;
wire  [4 - 1 : 0] bramS_WEN_A, bramS_WEN_B;
wire    [31 : 0]    bramS_Addr_A, bramS_Addr_B;
wire    [31 : 0]    bramS_Din_A, bramS_Din_B;
wire    [31 : 0]    bramS_Dout_A, bramS_Dout_B;
wire    bramS_ready;
wire    bramS_done;

`AESL_BRAM_S `AESL_BRAM_INST_S(
    .Clk_A    (bramS_Clk_A),
    .Rst_A    (bramS_Rst_A),
    .EN_A     (bramS_EN_A),
    .WEN_A    (bramS_WEN_A),
...
// Assignment between dut and bramS
assign bramS_Clk_A = S_CLK_A;
assign bramS_Rst_A = S_RST_A;
assign bramS_Addr_A = S_ADDR_A;
assign bramS_EN_A = S_EN_A;
assign bramS_WEN_A = S_WEN_A;
assign bramS_Din_A = S_DIN_A;
assign bramS_ready= ready_initial | bramS_done;
assign bramS_done =    AESL_done_delay;
