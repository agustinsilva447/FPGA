...
proc create_root_design { parentCell } {
  ...
  # Create instance: VQFTAXIBUS_0, and set properties
  set VQFTAXIBUS_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:VQFTAXIBUS:1.0 VQFTAXIBUS_0 ]

  # Create instance: VQFTAXIBUS_0_bram, and set properties
  set VQFTAXIBUS_0_bram [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.3 VQFTAXIBUS_0_bram ]
...
CONFIG.use_bram_block.VALUE_SRC {DEFAULT} \
  ...
  # Create instance: VQFTAXIBUS_0_bram_0, and set properties
  set VQFTAXIBUS_0_bram_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.3 VQFTAXIBUS_0_bram_0 ]
  set_property -dict [ list \
CONFIG.Enable_B {Use_ENB_Pin} \
CONFIG.Memory_Type {True_Dual_Port_RAM} \
CONFIG.Port_B_Clock {100} \
...
CONFIG.NUM_MI {4} \
  ...
  connect_bd_intf_net -intf_net VQFTAXIBUS_0_E_PORTA [get_bd_intf_pins VQFTAXIBUS_0/E_PORTA] [get_bd_intf_pins VQFTAXIBUS_0_bram/BRAM_PORTA]
  connect_bd_intf_net -intf_net VQFTAXIBUS_0_S_PORTA [get_bd_intf_pins VQFTAXIBUS_0/S_PORTA] [get_bd_intf_pins VQFTAXIBUS_0_bram_0/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTA [get_bd_intf_pins VQFTAXIBUS_0_bram/BRAM_PORTB] [get_bd_intf_pins axi_bram_ctrl_0/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_bram_ctrl_1_BRAM_PORTA [get_bd_intf_pins VQFTAXIBUS_0_bram_0/BRAM_PORTB] [get_bd_intf_pins axi_bram_ctrl_1/BRAM_PORTA]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins VQFTAXIBUS_0/s_axi_CRTL_BUS] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins VQFTAXIBUS_0/ap_rst_n] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs VQFTAXIBUS_0/s_axi_CRTL_BUS/Reg] SEG_VQFTAXIBUS_0_Reg
...
preplace port UART0_TX -pg 1 -y 460 -defaultsOSRD
preplace port UART0_RX -pg 1 -y 480 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 380 -defaultsOSRD
preplace inst VQFTAXIBUS_0_bram_0 -pg 1 -lvl 4 -y 190 -defaultsOSRD
preplace inst axi_timer_0 -pg 1 -lvl 3 -y 500 -defaultsOSRD
preplace inst VQFTAXIBUS_0_bram -pg 1 -lvl 4 -y 50 -defaultsOSRD
...
preplace inst VQFTAXIBUS_0 -pg 1 -lvl 3 -y 180 -defaultsOSRD
preplace inst axi_bram_ctrl_1 -pg 1 -lvl 3 -y 300 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -y 510 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 1 4 470J 390 NJ 390 NJ 390 1300J
preplace netloc ps7_0_axi_periph_M02_AXI 1 2 1 770
preplace netloc VQFTAXIBUS_0_E_PORTA 1 3 1 1100
preplace netloc axi_bram_ctrl_0_BRAM_PORTA 1 3 1 N
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 440
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 2 480 550 780
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 40 340 430
preplace netloc ps7_0_axi_periph_M03_AXI 1 2 1 750
preplace netloc ps7_0_axi_periph_M01_AXI 1 2 1 750
preplace netloc processing_system7_0_UART0_TX 1 1 4 490J 400 NJ 400 NJ 400 1300J
preplace netloc VQFTAXIBUS_0_S_PORTA 1 3 1 N
preplace netloc processing_system7_0_FIXED_IO 1 1 4 460J 380 NJ 380 NJ 380 NJ
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 30 330 450 600 760
preplace netloc axi_bram_ctrl_1_BRAM_PORTA 1 3 1 1100
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 N
preplace netloc UART0_RX_1 1 0 2 20J 670 420
preplace netloc rst_ps7_0_100M_interconnect_aresetn 1 1 1 430
levelinfo -pg 1 0 230 620 940 1200 1320 -top 0 -bot 780
",
}
