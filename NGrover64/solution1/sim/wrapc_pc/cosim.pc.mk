...
$(ObjDir)/NGrover64_test.cpp_pre.cpp.tb.o : NGrover64_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling NGrover64_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/NGrover64.cpp_pre.cpp.tb.o : NGrover64.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling NGrover64.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
