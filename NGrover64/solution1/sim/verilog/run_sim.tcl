...
if {[file isfile NGrover64.autotvin.dat]} {
	file delete -force NGrover64.autotvin.dat
}

if {[file isfile NGrover64.autotvout.dat]} {
	file delete -force NGrover64.autotvout.dat
}
