...
`define AUTOTB_DUT      NGrover64
`define AUTOTB_DUT_INST AESL_inst_NGrover64
`define AUTOTB_TOP      apatb_NGrover64_top
`define AUTOTB_LAT_RESULT_FILE "NGrover64.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "NGrover64.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_NGrover64_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_BRAM_E1 AESL_autobram_E1
`define AESL_BRAM_INST_E1 bram_inst_E1
...
`define AUTOTB_TVIN_E1_out_wrapc  "../tv/rtldatafile/rtl.NGrover64.autotvin_E1.dat"
`define AUTOTB_TVIN_B_out_wrapc  "../tv/rtldatafile/rtl.NGrover64.autotvin_B.dat"
`define AUTOTB_TVIN_C_out_wrapc  "../tv/rtldatafile/rtl.NGrover64.autotvin_C.dat"
`define AUTOTB_TVOUT_B  "../tv/cdatafile/c.NGrover64.autotvout_B.dat"
`define AUTOTB_TVOUT_B_out_wrapc  "../tv/rtldatafile/rtl.NGrover64.autotvout_B.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = -1;
parameter LENGTH_E1 = 64;
...
//------------------------bramE1 Instantiation--------------

// The input and output of bramE1
wire  bramE1_Clk_A, bramE1_Clk_B;
wire  bramE1_EN_A, bramE1_EN_B;
wire  [4 - 1 : 0] bramE1_WEN_A, bramE1_WEN_B;
wire    [31 : 0]    bramE1_Addr_A, bramE1_Addr_B;
wire    [31 : 0]    bramE1_Din_A, bramE1_Din_B;
wire    [31 : 0]    bramE1_Dout_A, bramE1_Dout_B;
wire    bramE1_ready;
wire    bramE1_done;

`AESL_BRAM_E1 `AESL_BRAM_INST_E1(
    .Clk_A    (bramE1_Clk_A),
    .Rst_A    (bramE1_Rst_A),
    .EN_A     (bramE1_EN_A),
    .WEN_A    (bramE1_WEN_A),
    .Addr_A   (bramE1_Addr_A),
    .Din_A    (bramE1_Din_A),
    .Dout_A   (bramE1_Dout_A),
    .Clk_B    (bramE1_Clk_B),
    .Rst_B    (bramE1_Rst_B),
    .EN_B     (bramE1_EN_B),
    .WEN_B    (bramE1_WEN_B),
    .Addr_B   (bramE1_Addr_B),
    .Din_B    (bramE1_Din_B),
    .Dout_B   (bramE1_Dout_B),
    .ready    (bramE1_ready),
    .done        (bramE1_done)
);

// Assignment between dut and bramE1
assign bramE1_Clk_A = E1_CLK_A;
assign bramE1_Rst_A = E1_RST_A;
assign bramE1_Addr_A = E1_ADDR_A;
assign bramE1_EN_A = E1_EN_A;
assign E1_DOUT_A = bramE1_Dout_A;
assign bramE1_WEN_A = 0;
assign bramE1_Din_A = 0;
assign bramE1_ready=    ready;
assign bramE1_done = 0;
...
assign bramB_WEN_A = B_WEN_A;
assign bramB_Din_A = B_DIN_A;
assign bramB_ready= ready;
assign bramB_done = interface_done;
