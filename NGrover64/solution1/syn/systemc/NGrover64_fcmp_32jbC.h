...
#ifndef __NGrover64_fcmp_32jbC__HH__
#define __NGrover64_fcmp_32jbC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(NGrover64_fcmp_32jbC) {
    ...
    SC_CTOR(NGrover64_fcmp_32jbC):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
