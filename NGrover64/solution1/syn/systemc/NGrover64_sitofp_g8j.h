...
#ifndef __NGrover64_sitofp_g8j__HH__
#define __NGrover64_sitofp_g8j__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(NGrover64_sitofp_g8j) {
    ...
    SC_CTOR(NGrover64_sitofp_g8j):  ACMP_sitofp_U ("ACMP_sitofp_U") {
