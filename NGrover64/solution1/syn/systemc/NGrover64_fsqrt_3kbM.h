...
#ifndef __NGrover64_fsqrt_3kbM__HH__
#define __NGrover64_fsqrt_3kbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(NGrover64_fsqrt_3kbM) {
    ...
    SC_CTOR(NGrover64_fsqrt_3kbM):  ACMP_fsqrt_U ("ACMP_fsqrt_U") {
