...
#ifndef __NGrover64_faddfsudEe__HH__
#define __NGrover64_faddfsudEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(NGrover64_faddfsudEe) {
    ...
    SC_CTOR(NGrover64_faddfsudEe):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
