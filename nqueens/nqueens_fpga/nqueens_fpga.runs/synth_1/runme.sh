...
HD_PWD='C:/Users/mlabadm/Desktop/Github/FPGA/nqueens/nqueens_fpga/nqueens_fpga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_nqueens.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_nqueens.tcl
