...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set reg0_o_0 [ create_bd_port -dir O -from 31 -to 0 reg0_o_0 ]
  ...
  connect_bd_net -net comblock_0_reg0_o [get_bd_ports reg0_o_0] [get_bd_pins comblock_0/reg0_o] [get_bd_pins top_nqueens_0/nRst]
  ...
  connect_bd_net -net top_nqueens_0_a [get_bd_pins comblock_0/reg2_i] [get_bd_pins top_nqueens_0/a]
