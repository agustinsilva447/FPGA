...
proc create_root_design { parentCell } {
  ...
  # Create instance: top_nqueens_0, and set properties
  set block_name top_nqueens
  set block_cell_name top_nqueens_0
  if { [catch {set top_nqueens_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $top_nqueens_0 eq "" } {
  ...
  connect_bd_net -net top_nqueens_0_a_in [get_bd_pins comblock_0/reg2_i] [get_bd_pins system_ila_0/probe3] [get_bd_pins top_nqueens_0/a_in]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets top_nqueens_0_a_in]
  connect_bd_net -net top_nqueens_0_counter [get_bd_pins comblock_0/reg1_i] [get_bd_pins system_ila_0/probe1] [get_bd_pins top_nqueens_0/counter]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets top_nqueens_0_counter]
  connect_bd_net -net top_nqueens_0_done [get_bd_pins comblock_0/reg0_i] [get_bd_pins system_ila_0/probe2] [get_bd_pins top_nqueens_0/done]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets top_nqueens_0_done]
