...
REM
REM Generated by Vivado on Fri Nov 26 19:19:24 +0100 2021
...
call xvlog  --incr --relax -L axi_vip_v1_1_11 -L processing_system7_vip_v1_0_13 -L xilinx_vip -prj fsm_tb_vlog.prj -log xvlog.log
