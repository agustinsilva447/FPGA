...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXIL is
  ...
  attribute SOFT_HLUTNM of \axi_rdata[7]_i_3\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \regs_out[0][3]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \regs_out[1][3]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \regs_out[2][3]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \regs_out[3][3]_i_1\ : label is "soft_lutpair1";
begin
...
\regs_out[3][3]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"40000000"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ComBlock is
  port (
    ...
    \regs_out_reg[3][3]_1\ : in STD_LOGIC_VECTOR ( 0 to 0 )
  );
...
begin
  ...
  reg3_o(3 downto 0) <= \^reg3_o\(3 downto 0);
...
AXIL_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXIL
     port map (
      ...
      \axi_awaddr_reg[7]_2\(0) => AXIL_inst_n_18,
      \axi_rdata_reg[0]_0\ => comblock_i_n_19,
      \axi_rdata_reg[1]_0\ => comblock_i_n_18,
      \axi_rdata_reg[2]_0\ => comblock_i_n_17,
...
comblock_i: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ComBlock
     port map (
      ...
      reg2_o(3 downto 0) => reg2_o(3 downto 0),
      reg3_o(3 downto 0) => reg3_o(3 downto 0),
      \regs_out_reg[1][3]_0\(0) => \regs_out[1]_1\,
      \regs_out_reg[2][3]_0\(0) => \regs_out[2]_2\,
      \regs_out_reg[3][0]_0\ => comblock_i_n_19,
      \regs_out_reg[3][1]_0\ => comblock_i_n_18,
      \regs_out_reg[3][2]_0\ => comblock_i_n_17,
      \regs_out_reg[3][3]_0\ => comblock_i_n_0,
      \regs_out_reg[3][3]_1\(0) => \regs_out[3]_0\
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
