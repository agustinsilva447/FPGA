...
entity design_1_fsm_0_2_ctrl_logic_fsm is
  port (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_fsm_0_2_up_counter is
  port (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_fsm_0_2_fsm is
  port (
    Q : out STD_LOGIC_VECTOR ( 0 to 0 );
...
dut: entity work.design_1_fsm_0_2_up_counter
     port map (
      D(1) => dut_n_6,
      D(0) => dut_n_7,
      E(0) => ce,
...
logic: entity work.design_1_fsm_0_2_ctrl_logic_fsm
     port map (
      AR(0) => reset_control,
      D(1) => logic_n_3,
      D(0) => logic_n_4,
...
entity design_1_fsm_0_2 is
  ...
  attribute NotValidForBitStream of design_1_fsm_0_2 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_fsm_0_2 : entity is "design_1_fsm_0_2,fsm,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_fsm_0_2 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of design_1_fsm_0_2 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of design_1_fsm_0_2 : entity is "fsm,Vivado 2021.2";
end design_1_fsm_0_2;

architecture STRUCTURE of design_1_fsm_0_2 is
...
begin
U0: entity work.design_1_fsm_0_2_fsm
     port map (
      Q(0) => output_state(2),
      a_in(7 downto 0) => a_in(7 downto 0),
