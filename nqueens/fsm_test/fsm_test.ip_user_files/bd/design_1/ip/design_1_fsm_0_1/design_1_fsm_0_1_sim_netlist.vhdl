...
-- Command     : write_vhdl -force -mode funcsim -rename_top design_1_fsm_0_1 -prefix
--               design_1_fsm_0_1_ design_1_fsm_0_1_sim_netlist.vhdl
...
entity design_1_fsm_0_1_ctrl_logic_fsm is
  port (
...
end design_1_fsm_0_1_ctrl_logic_fsm;

architecture STRUCTURE of design_1_fsm_0_1_ctrl_logic_fsm is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_fsm_0_1_up_counter is
  port (
...
end design_1_fsm_0_1_up_counter;

architecture STRUCTURE of design_1_fsm_0_1_up_counter is
...
dut: entity work.design_1_fsm_0_1_up_counter
     port map (
      D(1) => dut_n_6,
      D(0) => dut_n_7,
      E(0) => count,
...
logic: entity work.design_1_fsm_0_1_ctrl_logic_fsm
     port map (
      AR(0) => reset_control,
      D(1) => logic_n_4,
      D(0) => logic_n_5,
...
entity design_1_fsm_0_1 is
  ...
  attribute x_core_info of design_1_fsm_0_1 : entity is "fsm,Vivado 2021.2";
