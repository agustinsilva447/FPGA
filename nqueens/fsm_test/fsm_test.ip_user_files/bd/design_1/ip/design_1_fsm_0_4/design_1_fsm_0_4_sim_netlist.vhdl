...
-- Command     : write_vhdl -force -mode funcsim -rename_top design_1_fsm_0_4 -prefix
--               design_1_fsm_0_4_ design_1_fsm_0_4_sim_netlist.vhdl
...
entity design_1_fsm_0_4_ctrl_logic_fsm is
  port (
...
end design_1_fsm_0_4_ctrl_logic_fsm;

architecture STRUCTURE of design_1_fsm_0_4_ctrl_logic_fsm is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_fsm_0_4_up_counter is
  port (
...
end design_1_fsm_0_4_up_counter;

architecture STRUCTURE of design_1_fsm_0_4_up_counter is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_fsm_0_4_fsm is
  port (
...
end design_1_fsm_0_4_fsm;

architecture STRUCTURE of design_1_fsm_0_4_fsm is
...
dut: entity work.design_1_fsm_0_4_up_counter
     port map (
      D(1) => dut_n_7,
      D(0) => dut_n_8,
      E(0) => ce,
...
logic: entity work.design_1_fsm_0_4_ctrl_logic_fsm
     port map (
      AR(0) => reset_control,
      D(1) => logic_n_4,
      D(0) => logic_n_5,
...
entity design_1_fsm_0_4 is
  ...
  attribute NotValidForBitStream of design_1_fsm_0_4 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_fsm_0_4 : entity is "design_1_fsm_0_4,fsm,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_fsm_0_4 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of design_1_fsm_0_4 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of design_1_fsm_0_4 : entity is "fsm,Vivado 2021.2";
end design_1_fsm_0_4;

architecture STRUCTURE of design_1_fsm_0_4 is
  attribute x_interface_info : string;
  attribute x_interface_info of clk : signal is "xilinx.com:signal:clock:1.0 clk CLK";
  attribute x_interface_parameter : string;
  attribute x_interface_parameter of clk : signal is "XIL_INTERFACENAME clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, INSERT_VIP 0";
begin
U0: entity work.design_1_fsm_0_4_fsm
     port map (
      Q(0) => output_state(2),
      a_in(15 downto 0) => a_in(15 downto 0),
