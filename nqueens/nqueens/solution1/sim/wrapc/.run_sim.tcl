...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "nqueens.autotvin.dat"
	set constFileTvOut       "nqueens.autotvout.dat"
	set constFileHdlTvIn     "nqueens.autohdltvin.dat"
	set constFileHdlTvOut    "nqueens.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
