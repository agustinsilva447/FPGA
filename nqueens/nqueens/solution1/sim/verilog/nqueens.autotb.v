...
`define AUTOTB_DUT      nqueens
`define AUTOTB_DUT_INST AESL_inst_nqueens
`define AUTOTB_TOP      apatb_nqueens_top
`define AUTOTB_LAT_RESULT_FILE "nqueens.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "nqueens.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_nqueens_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AUTOTB_TVOUT_ap_return  "../tv/cdatafile/c.nqueens.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "../tv/rtldatafile/rtl.nqueens.autotvout_ap_return.dat"
module `AUTOTB_TOP;
