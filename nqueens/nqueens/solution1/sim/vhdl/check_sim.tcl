...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.nqueens.autotvout_a.dat"
         "c.nqueens.autotvout_k.dat"
         "c.nqueens.autotvout_u_0.dat"
         "c.nqueens.autotvout_sol_list.dat"
         "c.nqueens.autotvout_flag.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.nqueens.autotvout_a.dat"
         "rtl.nqueens.autotvout_k.dat"
         "rtl.nqueens.autotvout_u_0.dat"
         "rtl.nqueens.autotvout_sol_list.dat"
         "rtl.nqueens.autotvout_flag.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
