...
set IPName      "nqueens"
set Version     "1.0"
set DisplayName "Nqueens"
set Revision    "2108261216"
...
set sdx_kernel_name "nqueens"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "C:/Users/mlabadm/Desktop/Github/FPGA/nqueens/nqueens/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {nqueens_AXILiteS_s_axi
counter
find_0
nqueens
}
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x40 k_i W 0x0 "Data signal of k_i" {{0 32 k_i W 0 "Bit 31 to 0 Data signal of k_i"}}} {0x48 k_o R 0x0 "Data signal of k_o" {{0 32 k_o R 0 "Bit 31 to 0 Data signal of k_o"}}} {0x4c k_o_ctrl R 0x0 "Control signal of k_o" {{0 1 k_o_ap_vld R 0 "Control signal k_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 u_0_i W 0x0 "Data signal of u_0_i" {{0 32 u_0_i W 0 "Bit 31 to 0 Data signal of u_0_i"}}} {0x58 u_0_o R 0x0 "Data signal of u_0_o" {{0 32 u_0_o R 0 "Bit 31 to 0 Data signal of u_0_o"}}} {0x5c u_0_o_ctrl R 0x0 "Control signal of u_0_o" {{0 1 u_0_o_ap_vld R 0 "Control signal u_0_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x60 sol_list_i W 0x0 "Data signal of sol_list_i" {{0 32 sol_list_i W 0 "Bit 31 to 0 Data signal of sol_list_i"}}} {0x68 sol_list_o R 0x0 "Data signal of sol_list_o" {{0 32 sol_list_o R 0 "Bit 31 to 0 Data signal of sol_list_o"}}} {0x6c sol_list_o_ctrl R 0x0 "Control signal of sol_list_o" {{0 1 sol_list_o_ap_vld R 0 "Control signal sol_list_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x70 flag R 0x0 "Data signal of flag" {{0 32 flag R 0 "Bit 31 to 0 Data signal of flag"}}} {0x74 flag_ctrl R 0x0 "Control signal of flag" {{0 1 flag_ap_vld R 0 "Control signal flag_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
