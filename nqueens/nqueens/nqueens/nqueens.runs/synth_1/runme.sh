...
HD_PWD='C:/Users/mlabadm/Desktop/Github/FPGA/nqueens/nqueens/nqueens/nqueens.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nqueens_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nqueens_wrapper.tcl
