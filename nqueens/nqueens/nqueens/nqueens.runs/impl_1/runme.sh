...
HD_PWD='C:/Users/mlabadm/Desktop/Github/FPGA/nqueens/nqueens/nqueens/nqueens.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nqueens_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nqueens_wrapper.tcl -notrace
