...
HD_PWD='C:/Users/mlabadm/Desktop/Github/FPGA/nqueens/nqueens/nqueens/nqueens.runs/nqueens_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nqueens_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nqueens_auto_pc_0.tcl
