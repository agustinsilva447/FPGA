...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXIL is
  port (
    ...
    reg3_o : in STD_LOGIC_VECTOR ( 31 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXIL is
  ...
  signal \regs_out[4][31]_i_2_n_0\ : STD_LOGIC;
  signal sel0 : STD_LOGIC_VECTOR ( 3 downto 0 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of axi_wready_i_1 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \regs_out[0][31]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \regs_out[0][31]_i_3\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \regs_out[1][31]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \regs_out[2][31]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \regs_out[3][31]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \regs_out[4][31]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \regs_out[4][31]_i_2\ : label is "soft_lutpair0";
begin
...
\regs_out[0][31]_i_2\: unisim.vcomponents.LUT5
    generic map(
      ...
      I0 => reg_wr_adr(6),
      I1 => reg_wr_adr(5),
      I2 => \regs_out[0][31]_i_3_n_0\,
      I3 => reg_wr_adr(7),
      I4 => reg_wr_adr(4),
      O => \regs_out[0][31]_i_2_n_0\
    );
\regs_out[0][31]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
\regs_out[1][31]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"40"
    )
        port map (
...
\regs_out[2][31]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"40"
    )
        port map (
...
\regs_out[3][31]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
\regs_out[4][31]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0400"
    )
        port map (
      ...
      I1 => reg_wr_adr(4),
      I2 => reg_wr_adr(3),
      I3 => \regs_out[4][31]_i_2_n_0\,
      O => E(0)
    );
\regs_out[4][31]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0400"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_comblock is
  signal AXIL_inst_n_41 : STD_LOGIC;
...
AXIL_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXIL
     port map (
      ...
      \axi_awaddr_reg[3]_2\(0) => AXIL_inst_n_41,
      axil_aclk => axil_aclk,
