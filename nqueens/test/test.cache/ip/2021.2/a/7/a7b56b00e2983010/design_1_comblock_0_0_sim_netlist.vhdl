...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXIL is
  ...
  attribute SOFT_HLUTNM of \regs_out[0][0]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \regs_out[1][0]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \regs_out[2][0]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \regs_out[4][0]_i_2\ : label is "soft_lutpair0";
begin
...
\regs_out[1][0]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\regs_out[3][0]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\regs_out[4][0]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ComBlock is
  port (
    ...
    \regs_out_reg[0][0]_1\ : in STD_LOGIC;
    axil_aclk : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_comblock is
  ...
  signal comblock_i_n_5 : STD_LOGIC;
  signal \^reg0_o\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal \^reg1_o\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal \^reg2_o\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal \^reg3_o\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal \^reg4_o\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal reg_rd_adr : STD_LOGIC_VECTOR ( 5 downto 3 );
begin
  reg0_o(0) <= \^reg0_o\(0);
  reg1_o(0) <= \^reg1_o\(0);
  reg2_o(0) <= \^reg2_o\(0);
...
AXIL_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXIL
     port map (
      Q(2 downto 0) => reg_rd_adr(5 downto 3),
