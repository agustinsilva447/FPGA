...
-- Command     : write_vhdl -force -mode funcsim -rename_top design_1_comblock_0_1 -prefix
--               design_1_comblock_0_1_ design_1_comblock_0_1_sim_netlist.vhdl
...
entity design_1_comblock_0_1_AXIL is
  port (
    ...
    \axi_awaddr_reg[7]_3\ : out STD_LOGIC_VECTOR ( 0 to 0 );
    \axi_awaddr_reg[7]_4\ : out STD_LOGIC_VECTOR ( 0 to 0 );
    \axi_awaddr_reg[7]_5\ : out STD_LOGIC_VECTOR ( 0 to 0 );
    \axi_awaddr_reg[7]_6\ : out STD_LOGIC_VECTOR ( 0 to 0 );
...
end design_1_comblock_0_1_AXIL;

architecture STRUCTURE of design_1_comblock_0_1_AXIL is
  ...
  attribute SOFT_HLUTNM of \regs_out[0][31]_i_1\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \regs_out[5][31]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \regs_out[6][31]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \regs_out[7][31]_i_1\ : label is "soft_lutpair0";
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_comblock_0_1_ComBlock is
  port (
...
end design_1_comblock_0_1_ComBlock;

architecture STRUCTURE of design_1_comblock_0_1_ComBlock is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_comblock_0_1_axi_comblock is
  port (
    axil_awready : out STD_LOGIC;
    axil_wready : out STD_LOGIC;
    axil_arready : out STD_LOGIC;
...
end design_1_comblock_0_1_axi_comblock;

architecture STRUCTURE of design_1_comblock_0_1_axi_comblock is
  signal AXIL_inst_n_47 : STD_LOGIC;
  ...
  signal \regs_out[4]_6\ : STD_LOGIC;
  signal \regs_out[5]_4\ : STD_LOGIC;
  signal \regs_out[6]_2\ : STD_LOGIC;
  signal \regs_out[7]_0\ : STD_LOGIC;
begin
AXIL_inst: entity work.design_1_comblock_0_1_AXIL
     port map (
      E(0) => \regs_out[7]_0\,
      Q(2 downto 0) => reg_rd_adr(4 downto 2),
      \axi_awaddr_reg[7]_0\(0) => \regs_out[3]_1\,
      \axi_awaddr_reg[7]_1\(0) => \regs_out[6]_2\,
      \axi_awaddr_reg[7]_2\(0) => \regs_out[2]_3\,
      \axi_awaddr_reg[7]_3\(0) => \regs_out[5]_4\,
      \axi_awaddr_reg[7]_4\(0) => \regs_out[1]_5\,
      \axi_awaddr_reg[7]_5\(0) => \regs_out[4]_6\,
      \axi_awaddr_reg[7]_6\(0) => AXIL_inst_n_47,
...
comblock_i: entity work.design_1_comblock_0_1_ComBlock
     port map (
      E(0) => AXIL_inst_n_47,
      Q(2 downto 0) => reg_rd_adr(4 downto 2),
      ...
      \regs_out_reg[3][31]_0\(0) => \regs_out[3]_1\,
      \regs_out_reg[4][31]_0\(0) => \regs_out[4]_6\,
      \regs_out_reg[5][31]_0\(0) => \regs_out[5]_4\,
      \regs_out_reg[6][31]_0\(0) => \regs_out[6]_2\,
      \regs_out_reg[7][31]_0\(0) => \regs_out[7]_0\
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_comblock_0_1 is
  port (
    reg0_i : in STD_LOGIC_VECTOR ( 31 downto 0 );
    reg1_i : in STD_LOGIC_VECTOR ( 31 downto 0 );
    reg2_i : in STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  attribute NotValidForBitStream of design_1_comblock_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_comblock_0_1 : entity is "design_1_comblock_0_1,axi_comblock,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_comblock_0_1 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of design_1_comblock_0_1 : entity is "package_project";
  attribute x_core_info : string;
  attribute x_core_info of design_1_comblock_0_1 : entity is "axi_comblock,Vivado 2021.2";
end design_1_comblock_0_1;

architecture STRUCTURE of design_1_comblock_0_1 is
  signal \<const0>\ : STD_LOGIC;
  attribute x_interface_info : string;
  attribute x_interface_info of axil_aclk : signal is "xilinx.com:signal:clock:1.0 axil_aclk CLK";
  attribute x_interface_parameter : string;
  attribute x_interface_parameter of axil_aclk : signal is "XIL_INTERFACENAME axil_aclk, ASSOCIATED_RESET axil_aresetn, ASSOCIATED_BUSIF AXIL, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN design_1_processing_system7_0_1_FCLK_CLK0, INSERT_VIP 0";
...
U0: entity work.design_1_comblock_0_1_axi_comblock
     port map (
      axil_aclk => axil_aclk,
