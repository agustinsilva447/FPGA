...
`define AUTOTB_DUT      matrix_multiply_top
`define AUTOTB_DUT_INST AESL_inst_matrix_multiply_top
`define AUTOTB_TOP      apatb_matrix_multiply_top_top
`define AUTOTB_LAT_RESULT_FILE "matrix_multiply_top.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "matrix_multiply_top.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_matrix_multiply_top_top
...
`define AUTOTB_TVIN_A  "./c.matrix_multiply_top.autotvin_A.dat"
`define AUTOTB_TVIN_B  "./c.matrix_multiply_top.autotvin_B.dat"
`define AUTOTB_TVIN_C  "./c.matrix_multiply_top.autotvin_C.dat"
`define AUTOTB_TVIN_A_out_wrapc  "./rtl.matrix_multiply_top.autotvin_A.dat"
`define AUTOTB_TVIN_B_out_wrapc  "./rtl.matrix_multiply_top.autotvin_B.dat"
`define AUTOTB_TVIN_C_out_wrapc  "./rtl.matrix_multiply_top.autotvin_C.dat"
`define AUTOTB_TVOUT_C  "./c.matrix_multiply_top.autotvout_C.dat"
`define AUTOTB_TVOUT_C_out_wrapc  "./impl_rtl.matrix_multiply_top.autotvout_C.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.matrix_multiply_top.autotvout_C.dat", "r");
    fp2 = $fopen("./impl_rtl.matrix_multiply_top.autotvout_C.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.matrix_multiply_top.autotvout_C.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.matrix_multiply_top.autotvout_C.dat\"!");
    else begin
        $display("Comparing rtl.matrix_multiply_top.autotvout_C.dat with impl_rtl.matrix_multiply_top.autotvout_C.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
