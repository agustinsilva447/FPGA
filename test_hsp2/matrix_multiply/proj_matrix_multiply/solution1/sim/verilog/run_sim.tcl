...
if {[file isfile matrix_multiply_top.autotvin.dat]} {
	file delete -force matrix_multiply_top.autotvin.dat
}

if {[file isfile matrix_multiply_top.autotvout.dat]} {
	file delete -force matrix_multiply_top.autotvout.dat
}
