...
# ==============================================================
set ::env(LD_LIBRARY_PATH) /home/agustinsilva447/Vivado/Vivado/2019.2/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/agustinsilva447/Vivado/Vivado/2019.2/lnx64/tools/opencv:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/agustinsilva447/Vivado/Vivado/2019.2/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/agustinsilva447/Vivado/Vivado/2019.2/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/agustinsilva447/Vivado/Vivado/2019.2/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "matrix_multiply_top.autotvin.dat"
	set constFileTvOut       "matrix_multiply_top.autotvout.dat"
	set constFileHdlTvIn     "matrix_multiply_top.autohdltvin.dat"
	set constFileHdlTvOut    "matrix_multiply_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
