...
################################################################
# This is a generated script based on design: comblock
#
...
proc create_root_design { parentCell } {
  ...
  set sws [ create_bd_port -dir I -from 7 -to 0 sws ]
  ...
  connect_bd_net -net reg0_i_0_1 [get_bd_ports sws] [get_bd_pins comblock_0/reg0_i]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins comblock_0/axif_aresetn] [get_bd_pins comblock_0/axil_aresetn] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
